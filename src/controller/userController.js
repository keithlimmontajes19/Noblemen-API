...
export const tokenUserChecker = async (req, res) => {
  try {
    return res
      .status(200)
      .json(RESPONSE(200, CONSTANTS.TOKEN_VALID, {}, STATUS_CODE.TOKEN_VALID));
  } catch (e) {
    return res
      .status(403)
      .json(
        RESPONSE(403, CONSTANTS.TOKEN_EXPIRED, {}, STATUS_CODE.TOKEN_EXPIRED),
      );
  }
};
